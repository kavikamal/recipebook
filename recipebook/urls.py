...
from recipebook.views import home_view, author_view, recipe_view, new_recipe_add, new_author_add, login_user, signup_user, logout_user
...
urlpatterns = [
    ...
    path('newauthoradd/', new_author_add),
